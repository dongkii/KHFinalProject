...
button.addEventListener("click", function() {
    sendAjax('http://localhost:8887/fitnessground');
})
...
app.post('/', function(req, res){
	  ...
	  var query =  connection.query('select  category1,  sum(readcount) readcount from tb_video_board group by category1', function(err,rows){ 
	    responseData.score = [];
	    if(err) throw err;
	    if(rows[0]){
