...
<style>
	...
	th {width:120px; font-weight:bold !important;}
		...
		<div class="modal-content" id="gymQModalC">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
				<form action="gymQnAInsert.do" id="gymQnAForm" method="post" enctype="multipart/form-data">
					...
					<div class="modal-footer" id="insertBt"><button id="gymQSendBt" class="btn btn-default" onclick="return gymQnAInsert();">Send</button></div>
				</form>
			</div>
		</div>
	</div>
